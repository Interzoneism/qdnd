...
namespace QDND.Tests.Unit
{
    public class AITargetEvaluatorTests
    {
        ...
        private class TestableAITargetEvaluator : AITargetEvaluator
        {
            ...
            public new List<Combatant> GetEnemies(Combatant actor)
            {
            ...
            public new List<Combatant> GetAllies(Combatant actor)
            {
                return _mockContext.GetAllCombatants()
        ...
        public void EvaluateTargets_ReturnsAllEnemies()
        {
            ...
            Assert.True(scores.Any(s => s.TargetId == enemy1.Id));
            Assert.True(scores.Any(s => s.TargetId == enemy2.Id));
        }
