...
{
    /// <summary>
    /// Tests for HUD UI models.
    /// Note: All tests are skipped because HUD models inherit from Godot.RefCounted
    /// and use EmitSignal, which requires the Godot runtime to function.
    /// </summary>
    public class HUDModelTests
    {
        #region TurnTracker Tests

        [Fact(Skip = "Requires Godot runtime - TurnTrackerModel inherits from RefCounted")]
        ...
        [Fact(Skip = "Requires Godot runtime - ActionBarModel inherits from RefCounted")]
        ...
        [Fact(Skip = "Requires Godot runtime - ResourceBarModel inherits from RefCounted")]
